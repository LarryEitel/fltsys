...
set PYTHONPATH=%PROJECT_ROOT%;%PROJECT_ROOT%\ve\Lib;%PROJECT_ROOT%\ve\Lib\site-packages;%PYTHON_ROOT%;%PYTHON_ROOT%\Lib;%PYTHON_ROOT%\Lib\site-packages;%GEOS_LIBRARY_PATH%
