...
settings.EVERNOTE_CONSUMER_KEY
settings.EVERNOTE_CONSUMER_SECRET

# YOU MUST FILL THESE IN! GET ACCESS AT: http://www.evernote.com/about/developer/api/
MY_CONSUMER_KEY = settings.EVERNOTE_CONSUMER_KEY
MY_CONSUMER_SECRET = settings.EVERNOTE_CONSUMER_SECRET
MY_USER = settings.EVERNOTE_USER
MY_PW = settings.EVERNOTE_PW
